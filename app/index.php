...
<body>
  ...
  <div id="tickets">
    <h2>tickets for <?php echo $business_name; ?></h2><?php
    ticketList($mysqli);
    ?>
    <div class="add_form">
      <h4>add ticket</h4>
      <form action="addTicket.php" method="post">
        <?php business_id_select($mysqli); ?><label for="what">what</label>
        <textarea name="what" type="textarea"></textarea><br>
  ...
  <div id="contacts">
    ...
    <div class="add_form">
      ...
      <form action="addContact.php" method="post">
        <?php business_id_select($mysqli); ?><label for="name">name</label><input name="name" type="text"><br>
