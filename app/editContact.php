...
if ($_POST["contactIdToEdit"] && !$_POST["contactId"]) { // show edit form
    // Perform Query
    $result = $mysqli->query("select * from brm_contact where id = ".
        $mysqli->real_escape_string($_POST["contactIdToEdit"]).";");
...
<body>
  <div style="border: 1px solid black;">
    ...
    <form action="editContact.php" method="post">
      <input type="hidden" name="contactId" value="<?php echo $_POST['contactIdToEdit'] ?>"><br>
